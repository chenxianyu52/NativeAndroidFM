...
class ModuleMappingCollector {

    private static final String PACKAGE_NAME = 'com/xianyu/androidfm'
    private static final String CLASS_NAME_PREFIX = 'KoinModuleMapping_'
